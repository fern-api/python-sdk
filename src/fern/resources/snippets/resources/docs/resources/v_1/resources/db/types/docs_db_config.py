...
from ...read.types.colors_config_v_2 import ColorsConfigV2
...
from ...read.types.logo_v_2 import LogoV2
from ...read.types.navbar_link import NavbarLink
from ...read.types.url import Url
from .docs_typography_config import DocsTypographyConfig
from .navigation_config import NavigationConfig


class DocsDbConfig(pydantic.BaseModel):
    ...
    colors_v_3: typing.Optional[ColorsConfigV3] = pydantic.Field(alias="colorsV3")
    navbar_links: typing.Optional[typing.List[NavbarLink]] = pydantic.Field(alias="navbarLinks")
